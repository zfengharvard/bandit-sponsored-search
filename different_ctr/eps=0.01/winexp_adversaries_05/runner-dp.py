...
(winexp, winexp_regrets) = regret_winexp(bidder_winexp, T, num_repetitions, num_bidders, num_slots, outcome_space, rank_scores, ctr, reserve, values, cpy1, threshold,noise_cpy1,num_adaptive)


#this has to be returned as a list of all the regrets for all the rounds 
#no need to observe threshold
(exp3, exp3_regrets) = regret_exp3(bidder_exp3,T,num_repetitions, num_bidders, num_slots, outcome_space, rank_scores, ctr, reserve, values, cpy2,threshold,noise_cpy2,num_adaptive)
...
plt.savefig('winexp_adversaries_noisy.png')
