########
# File that specifies the auction parameters to be used in each iteration. 
########
...
def set_auction_params(T,num_repetitions):
    ...
    # could be thought of as the conversion rate for every slot
    ...
    #noise = [np.random.normal(0,math.sqrt(1/1000),num_slots+1) for _ in range(0,T)]
