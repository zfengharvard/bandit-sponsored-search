...
def main_exp3(bidder,curr_rep, T,num_bidders, num_slots, outcome_space, rank_scores, ctr, reserve, values,bids,num_auctions):
    algo_util  = []
    temp_regr  = []
    for t in range(0,T):
        ...
        for auction in range(0,num_auctions):
            ...
            #print ("Auction=%d, alloc func"%auction)
            ...
            #print ("Auction=%d, pay func"%auction)
            #print bidder.pay_func
    
            bidder.reward_func[auction][t] = compute_reward(bidder.alloc_func[auction][t], bidder.pay_func[t], ctr[auction][t], values[auction][t],num_auctions)
            ...
            bidder.utility[auction][t] = [bidder.reward_func[auction][t][b]*bidder.alloc_func[auction][t][b] for b in range(0, bidder.bid_space)]
