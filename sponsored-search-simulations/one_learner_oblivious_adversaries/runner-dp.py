...
T = max_num_rounds
(num_bidders, num_slots, outcome_space, rank_scores, ctr, reserve, values, threshold) = set_auction_params(T,num_repetitions,num_auctions)
...
(winexp, winexp_regrets) = regret_winexp(bidder, T, num_repetitions, num_bidders, num_slots, outcome_space, rank_scores, ctr, reserve, values, cpy1, num_auctions, threshold)
